...
export type BedrockPacketEventMap = {
  ...
  server_to_client_handshake: (
    packet: packet_server_to_client_handshake
  ) => void;
  client_to_server_handshake: (
    packet: packet_client_to_server_handshake
  ) => void;
  ...
  resource_pack_client_response: (
    packet: packet_resource_pack_client_response
  ) => void;
  ...
  resource_pack_chunk_request: (
    packet: packet_resource_pack_chunk_request
  ) => void;
  ...
  initiate_web_socket_connection: (
    packet: packet_initiate_web_socket_connection
  ) => void;
  ...
  set_local_player_as_initialized: (
    packet: packet_set_local_player_as_initialized
  ) => void;
  ...
  available_entity_identifiers: (
    packet: packet_available_entity_identifiers
  ) => void;
  level_sound_event_v2: (packet: packet_level_sound_event_v2) => void;
  network_chunk_publisher_update: (
    packet: packet_network_chunk_publisher_update
  ) => void;
  ...
  on_screen_texture_animation: (
    packet: packet_on_screen_texture_animation
  ) => void;
  map_create_locked_copy: (packet: packet_map_create_locked_copy) => void;
  structure_template_data_export_request: (
    packet: packet_structure_template_data_export_request
  ) => void;
  structure_template_data_export_response: (
    packet: packet_structure_template_data_export_response
  ) => void;
  ...
  client_cache_miss_response: (
    packet: packet_client_cache_miss_response
  ) => void;
  ...
  position_tracking_db_broadcast: (
    packet: packet_position_tracking_db_broadcast
  ) => void;
  position_tracking_db_request: (
    packet: packet_position_tracking_db_request
  ) => void;
  ...
  correct_player_move_prediction: (
    packet: packet_correct_player_move_prediction
  ) => void;
  ...
  client_start_item_cooldown: (
    packet: packet_client_start_item_cooldown
  ) => void;
  ...
  toggle_crafter_slot_request: (
    packet: packet_toggle_crafter_slot_request
  ) => void;
  set_player_inventory_options: (
    packet: packet_set_player_inventory_options
  ) => void;
  ...
  serverbound_loading_screen: (
    packet: packet_serverbound_loading_screen
  ) => void;
  ...
  container_registry_cleanup: (
    packet: packet_container_registry_cleanup
  ) => void;
  ...
  client_movement_prediction_sync: (
    packet: packet_client_movement_prediction_sync
  ) => void;
  ...
  player_update_entity_overrides: (
    packet: packet_player_update_entity_overrides
  ) => void;
  player_location: (packet: packet_player_location) => void;
  clientbound_controls_scheme: (
    packet: packet_clientbound_controls_scheme
  ) => void;
  server_script_debug_drawer: (
    packet: packet_server_script_debug_drawer
  ) => void;
  serverbound_pack_setting_change: (
    packet: packet_serverbound_pack_setting_change
  ) => void;
  clientbound_data_store: (packet: packet_clientbound_data_store) => void;
  graphics_override_parameter: (
    packet: packet_graphics_override_parameter
  ) => void;
