...
import type * as protocolTypes from './bedrock-types';
...
import logger = require('./lib/logger/logger.mts');

export type * as protocolTypes from './bedrock-types';
...
export interface BedrockBot extends Bot {
  ...
  test:{
    tick(): protocolTypes.packet_player_auth_input;
